...
const Auth = (props) => {
    ...
    return (
        <div className="Auth Grey-BG pb-5">
            ...
            {props.auth ? (
                <Modal small success closeModal={() => props.history.push('/')}>
            ...
            {props.loading ? (
                ...
                <form className="AuthForm  pt-4 py-4" onSubmit={handleFormSubmit}>
                            ...
                            <React.Fragment>
                                ...
                                <div className="FormGroup">
                                    <input
                                        type="text"
                                        className={
                                            form.phone.touched && !form.phone.valid
                                                ? 'FormControl Invalid'
                                                : 'FormControl'
                                        }
                    ...
                    <div className="FormGroup">
                        ...
                        {form.email.touched && !form.email.valid ? (
                            <p className="Red d-block text-center mx-auto mt-2 Font6">Please enter a valid email</p>
                        ) : null}
                    </div>
                    <div className="FormGroup">
                        <input
                            type="password"
                            className={
                                form.password.touched && !form.password.valid ? 'FormControl Invalid' : 'FormControl'
                            }
                    ...
                    {signUp ? (
                        <div className="FormGroup">
                            <input
                                type="password"
                                className={
                                    form.confirmPassword.touched && !form.confirmPassword.valid
                                        ? 'FormControl Invalid'
                                        : 'FormControl'
                                }
                            ...
                            />
                            {form.confirmPassword.touched && !form.confirmPassword.valid ? (
                                <p className="Red d-block text-center mx-auto mt-2 Font6">Your passwords must match</p>
                            ) : null}
                        </div>
                    ) : null}
            ...
            <p className="Font6 Blue Link" onClick={handleSignUpChange}>
                {signUp ? 'Already registered? Click here to login!' : 'Not registered? Click here to sign up!'}
            </p>
        </div>
    );
};
