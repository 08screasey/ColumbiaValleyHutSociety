...
const AccountInfo = (props) => {
	...
	return (
		<div className="AccountInfo Grey-BG container-fluid">
			...
			{!props.userData.active ? <small>Note: Your account is not yet verified. Please activate your account through the email provided</small> : null}
			<div className="text-left m-auto" style={{padding:"0 7%", maxWidth:"800px"}}>
				...
				{props.userData.comments.length > 0 ? props.userData.comments.map((comment) => {
