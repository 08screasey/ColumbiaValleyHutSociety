            ...
            <div className="ReservationBook">
                ...
                <div className="Breakdown px-5">
                    <ObjectTable
                        object={{
                            Cabin: cabin.name,
                            Arrival: props.booking.dates[0],
                            Checkout: new Date(
                                Date.parse(props.booking.dates[props.booking.dates.length - 1]) + 60000 * 60 * 24,
                            ).toDateString(),
                    ...
                    <h3 className="DarkBlue Font5">Please Fill Out The Fields Below</h3>
                    <form onSubmit={handleSubmit}>
                        <div className="FormGroup">
                            ...
                            <input
                                ...
                                required
                                className={
                                    form.name.touched && !form.name.valid ? 'FormControl Invalid' : 'FormControl'
                                }
                            />
                        ...
                        <div className="FormGroup">
                            ...
                            <input
                                ...
                                required
                                className={
                                    form.email.touched && !form.email.valid ? 'FormControl Invalid' : 'FormControl'
                                }
                            />
                        ...
                        <div className="FormGroup">
                            ...
                            <input
                                ...
                                required
                                className={
                                    form.phone.touched && !form.phone.valid ? 'FormControl Invalid' : 'FormControl'
                                }
                            />
                ...
                {props.completedReservation ? (
                    ...
                    >
                        <BookingReview
                            bookingDetails={props.completedReservation}
                            clicked={() => props.onResetBooking()}
                        />
                    </Modal>
                ) : props.error ? (
