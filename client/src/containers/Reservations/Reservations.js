                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="px-3 py-2 mb-4">
                            <h2 className="Font2 m-0 Orange TextOutline">Reservations</h2>
                        </div>

                        <Switch>
                            {props.auth ? (
                                <React.Fragment>
                                    <Route path={props.match.url + '/success'} exact component={PaymentSuccess} />
                                    <Route path={props.match.url + '/huts/:hut'} exact component={ReservationDates} />
                                    <Route
                                        path={props.match.url + '/huts/:hut/book'}
                                        exact
                                        component={ReservationBook}
                                    />
                                    <Route path={props.match.url + '/huts'} exact component={ReservationIcons} />
                                    <Route path={props.match.url + '/'} exact component={ReservationInfo} />
                                </React.Fragment>
                            ) : (
                                <Route path={props.match.url + '/'} exact component={ReservationInfo} />
                            )}
