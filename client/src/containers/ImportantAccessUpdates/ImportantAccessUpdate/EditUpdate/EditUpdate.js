...
const EditUpdate = (props) => {
    return (
        <div className="w-100">
            {props.updateSuccess ? (
                <Modal small success closeModal={props.closeEdit}>
                    <div className="text-center">
                        <FontAwesomeIcon icon={faCheckCircle} className="Green m-auto" size="4x" />
                        <p className="mx-auto my-3">Post successfully submitted</p>
                    </div>
                </Modal>
            ) : null}
            <form onSubmit={props.formSubmit}>
                <div>
                    ...
                    />
                    {props.form.header.touched && !props.form.header.valid ? (
                        <p className="Red d-block text-center m-auto Font6">Please enter a title for your post</p>
                    ) : null}
                </div>
