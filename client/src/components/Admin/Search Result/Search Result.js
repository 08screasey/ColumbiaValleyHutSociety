...
const SearchResult = (props) => {
    ...
    return (
        <li className="SearchResult Raised p-3">
            <div className="d-flex justify-content-end mb-3">
                <span onClick={props.editClicked}>
                    <FontAwesomeIcon icon={faPencilAlt} className="Green text-right mr-5" size="1x" />
                </span>
                <span onClick={props.deleteClicked}>
                    <FontAwesomeIcon icon={faTrashAlt} className="Red text-right mr-5" size="1x" />
                </span>
            </div>
