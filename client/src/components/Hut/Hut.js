					...
					<div className="row">
						<div className="col-lg-4 col-xl-3 order-md-1 order-2">
							<OpacityAnimation classes="my-3">
								...
								<h5 className="Font4 Orange">
									Topographical maps:
								</h5>
								<p>
									Order online from Service BC. Rocky Mountain
									Forest District offers free Recreation Maps
									that will show most of the current roads.{" "}
								</p>
								<h5 className="Font4 Orange">
									Road Conditions:
								</h5>
								<p>
									It is advisable to check our Access Updates
									tab for the status of the roads you will be
									driving prior to heading in to a hut.
								</p>
								<h5 className="Font4 Orange">
									Avalance Report:
								</h5>
							...
							<div className=" Grey-BG py-3 px-2 Hut-FGO my-5 Raised">
								<h4 className="Font4 DarkBlue TextOutline">
									Formal Government Objectives:
								</h4>
								<p className="Font6 text-left">
									{props.hut.FGO}
								</p>
							</div>
							<HutMap {...props.hut} />
							<div className="p-3">
								{props.auth && (
									<button
										...
										onClick={() => {
											props.history.push(
												`/reservations/huts/${props.hut.dbName}`
											);
										}}
									>
										Make A Reservation
						...
						<div className="col-lg-8 col-xl-6 order-md-2 order-1">
							...
							<HutStats {...props} />
							<Hr />
							<h4 className="DarkBlue Font0 TextOutline">
								Getting There
							</h4>
							...
							<HutProvisions
								provisions={props.hut.provisions}
