export const RULES_DATA = [
	{
		...
		text:
			"Each of our huts is outfitted to a similar standard. The list below contains items neccessary before arrival",
		rules: [
	...
	},
	{
		...
		text:
			"Since these cabins are user-maintained please follow the housekeeping guidelines, as well as any noted at the cabin itself",
		rules: [
	...
	},
	{
		header: "On Departure",
		text:
			"After a fantastic stay we ask that you leave the hut ready for the next guests. Thank you for your consideration in following these rules. Remember to:",
		rules: [
